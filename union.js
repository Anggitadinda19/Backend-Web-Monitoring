...
app.use("/images", express.static(path.join(__dirname, "imageLaporan")));
app.use("/dokumentasi", express.static(path.join(__dirname, "imageLaporan")));
app.use("/dokumentasi", express.static(path.join(__dirname, "imageLaporan")));
app.use("/imageLaporan", express.static("imageLaporan")); // tambahan
